    ...
    <div className="card mb-3 shadow-sm">
      <div className="row no-gutters">
        <div className="col-md-12">
          <img src={photo} className="card-img shadow" alt="..." />
          <div className="card-img-overlay card-text">
            <p>
              <span className="badge badge-light">Ano - {vehicle.anoveic}</span>
            </p>
            <p>
              <span className="badge badge-light">
                Combustível - {vehicle.desc_Combustivel}
              </span>
            </p>
            <p>
              <span className="badge badge-light">
                Câmbio - {vehicle.desc_TipoCambio}
              </span>
            </p>
            <p>
              <span className="badge badge-light">
                Portas - {vehicle.num_NumPortas}
              </span>
            </p>
            <p>
              <span className="badge badge-light">
                Cor - {vehicle.cor_Veiculo}
              </span>
            </p>
          </div>
        </div>
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <small className="text-muted">
                {vehicle.obs_Veiculo.substr(0, 200)}
            ...
            <Link
              to={`/detalhes/${vehicle.iD_Veiculo}/${DescVeic}`}
