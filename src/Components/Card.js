        ...
        <div className="row no-gutters">
          <div className="col-md-12">
            ...
            <div class="card-img-overlay card-text">
              <p><span class="badge badge-light">Ano - {vehicle.anoveic}</span></p>
              <p><span class="badge badge-light">Combustível - {vehicle.desc_Combustivel}</span></p>
              <p><span class="badge badge-light">Câmbio - {vehicle.desc_TipoCambio}</span></p>
              <p><span class="badge badge-light">Portas - {vehicle.num_NumPortas}</span></p>
              <p><span class="badge badge-light">Cor - {vehicle.cor_Veiculo}</span></p>
            </div>
          </div>
          <div className="col-md-12">
