        ...
        <div className="card-body">
          ...
          <div className="input-group input-group-lg">
            ...
            <div className="input-group-append">
              <button className="btn btn-danger" type="button" id="button-addon1" data-toggle="tooltip" data-placement="top" title="Busca">Pesquisar</button>
              <button className="btn btn-warning" type="button" id="button-addon2" data-toggle="modal" data-target="#modalSearch"><i className="fab fa-searchengin"></i></button>
            </div>
          </div>
          <div className="col-sm-12 col-md-12 col-lg-12 m-0">
            <p>
              <a className="text-dark" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
