          ...
          <div className="col-sm-12 col-md-12 col-lg-7">
            <div className="row">
              <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner">
                  {photos.map((photo, index) => (
                    <div key={photo.url} className={`carousel-item ${index === 0 && 'active'}`}>
              ...
              <div className="col-div-lightbox mt-3">
                {photos.map(photo => (
                  <img className="img-lightbox-custom" onClick={() => setToggler(!toggler)} key={photo.url} src={photo.url} alt="photos" />
                ))}
                <FsLightbox
                  toggler={toggler}
                  customSources={
                    photos.map(photo => (
                      <img className="img-lightbox-custom" key={photo.url} src={photo.url} alt="photos" />
                    ))
                  }
                />
              </div>
                        ...
                        <div className="card-body">
                          ...
                          <div className="card-text">
                            <div className="form-group">
                              ...
                              <input type="text" className="form-control" id="nome" placeholder="name@examplo.com" />
                            </div>
                            <div className="form-group">
                              <label htmlFor="exampleFormControlInput1">E-mail</label>
                              <input type="email" className="form-control" id="email" placeholder="name@examplo.com" />
                            </div>
                            <div className="form-group">
                              <label htmlFor="exampleFormControlSelect1">Motivo do contato</label>
                            ...
                            <div className="form-group">
                              <label htmlFor="exampleFormControlTextarea1">Deixe uma mensagem</label>
